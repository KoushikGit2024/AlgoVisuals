...
// FIXES: BUG-01 (docsNav was exported but never defined), BUG-05 (route href mismatches)
...
// FIXED BUG-01: docsNav is now properly defined (alias of NAV for backward compat)
const docsNav = NAV;
